                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                ...
                                <form  method="post" action="Function/NewCars/AddBrands.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"  style="padding-top: 80px;" >
                                                ...
                                                <span class="input-group-addon"></i></span>
                                                        <input type="text" name="name" value="" class="form-control" id="username" placeholder="Name" required>
                                                    </div>
                                                ...
                                                <div class="input-group mg-b-pro-edt" style="margin-bottom:20%">
                                                <span class="input-group-addon"></i></span>
                                                        <input type="file" name="image" value="" class="form-control" id="image" placeholder="image" required>
                                                    </div>
