                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                ...
                                <form  method="post" action="Function/Admin/AddAdmin.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"  style="padding-top: 80px;" >
                                                ...
                                                <div class="input-group mg-b-pro-edt" style="margin-bottom:20%">
                                                    ...
                                                    <input type="text" name="name" value="" class="form-control <?=$border?>" id="username" 
                                                      placeholder="<?= !isset($placeholder) ? '' : $placeholder   ?>"  placeholder="Edit name" required>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"style="padding-top: 80px;" >
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt" style="margin-bottom:20%">
                                                        ...
                                                        <input type="text" name="phone" value="" class="form-control" id="phone" placeholder="Edit phone" required>
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt" style="margin-bottom:20%">
                                                        <span class="input-group-addon"><i class="icon nalika-new-file" aria-hidden="true"></i>
                                                        </span>
                                                        <input type="text" name="address" value="" class="form-control" id="address"  placeholder="Edit address" required>
                                                    ...
                                                    <div class="input-group mg-b-pro-edt" style="margin-bottom:20%">
                                                        ...
                                                        <input type="text" name="priv_id" value="" class="form-control" id="priv_id"  placeholder=" priv_id" required>
