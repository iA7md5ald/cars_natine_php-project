        ...
        <nav id="sidebar" class="">
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a class="profile" href="#"><img src="images/logo.png" alt="" /></a>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="index.html">
								   ...
								   <span class="mini-click-non">الجداول</span>
								</a>
                            <ul class="submenu-angle" aria-expanded="true">
                            <li><a title="الصفحه الرئيسيه" href="Index.php"><span class="mini-sub-pro">الصفحة الرئيسيه </span></a></li>
                             <li><a title="جدول الادمن" href="Admin.php"><span class="mini-sub-pro">جدول الادمن </span></a></li>
                             <li><a title="جدول العملاء" href="User.php"><span class="mini-sub-pro">جدول العملاء</span></a></li>
                        ...
                        <li>
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"> <span class="mini-click-non">جداول السيارات</span></a>
                            <ul class="submenu-angle" aria-expanded="false">

                            <li><a title="سيارات جديده" href="Brands.php"><span class="mini-sub-pro"> السيارات الجديده</span></a></li>
                            <li><a title="سيارات مستعمله" href="UsedCars.php"><span class="mini-sub-pro"> السيارات المستعمله</span></a></li>
                            <li><a title="تاجير سيارات" href="RentCars.php"><span class="mini-sub-pro"> تاجير سيارات</span></a></li>

                            </ul>
                        </li>
                        <li><a title="تسجيل خروج" href="Function/Logout.php"> <span class="mini-sub-pro">تسجيل خروج</span></a></li>
