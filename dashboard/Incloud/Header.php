        ...
        <div class="header-advance-area">
                    ...
                    <div class="row">
                        <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                            <div class="header-top-wraper">
                                <div class="row"> <!-- La La La La-->
                                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                        <div class="header-right-info">
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                <!-- <li class="nav-item nav-setting-open open"><a href="#" data-toggle="dropdown" role="button" aria-expanded="true" class="nav-link dropdown-toggle"><i class="icon nalika-menu-task"></i></a>
                                                        ...
                                                        <div class="tab-content custom-bdr-nt">
                                                            <div id="Notes" class="tab-pane fade in active">
                                                                <div class="notes-area-wrap">
                                                                    ...
                                                                    <div class="notes-list-area notes-menu-scrollbar mCustomScrollbar _mCS_4 mCS-autoHide mCS_no_scrollbar _mCS_3 mCS-dir-rtl" style="position: relative; overflow: visible;"><div id="mCSB_3" class="mCustomScrollBox mCS-light mCSB_vertical"><div id="mCSB_3_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="rtl"><div id="mCSB_4" class="mCustomScrollBox mCS-light-1 mCSB_vertical mCSB_outside mCSB_inside" tabindex="0" style="max-height: 315px;"><div id="mCSB_4_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="ltr">
                                                            ...
                                                            <div id="Projects" class="tab-pane fade">
                                                                <div class="projects-settings-wrap">
                                                                    ...
                                                                    <div class="project-st-list-area project-st-menu-scrollbar mCustomScrollbar _mCS_5 mCS-autoHide _mCS_4 mCS-dir-rtl" style="position: relative; overflow: visible;"><div id="mCSB_4" class="mCustomScrollBox mCS-light mCSB_vertical"><div id="mCSB_4_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="rtl"><div id="mCSB_5" class="mCustomScrollBox mCS-light-1 mCSB_vertical mCSB_outside" tabindex="0" style="max-height: 315px;"><div id="mCSB_5_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
            ...
            <div class="breadcome-area">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="breadcome-list" style="width:139%;">
                                <div class="row">
